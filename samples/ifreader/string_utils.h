...
#ifndef PG_STRING_UTILS_H
#define PG_STRING_UTILS_H
 ...
 */
char *
pg_strndup(const char * str, const size_t n);
 ...
 */
struct pair_string *
pair_string_create(const char * str, const char delim);
 ...
 */
void
pair_string_destroy(struct pair_string * pair);

#endif      /*  PGUTILS_STRING_UTILS_H  */
